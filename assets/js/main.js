...
const initializeVideoCarousel = () => {
  ...
  const videoProjects = [
    ...
    { id: "afree-day-short-form", title: "어프리데이 숏폼 광고", category: "Short-form AD", tags: ["Commercial", "Short-form", "AI Video", "Motion Graphics"], description: "논알콜 브랜드 ‘어프리데이’를 주제로 제작한 숏폼 광고 프로젝트입니다.\n‘오늘의 즐거움과 내일의 가벼움’을 초현실적인 상황과 유쾌한 언어유희로 표현했습니다.", period: "2026.08 – 2026.09", contribution: ["100%"], documentLabel: "기획서", document: { label: "PDF 보기", url: "" }, images: [{ src: "./assets/images/video-projects/afree-day-short-form-thumbnail.png", alt: "어프리데이 숏폼 광고 임시 썸네일" }], documentLinks: [] },
